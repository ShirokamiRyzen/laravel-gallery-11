        ...
        <div class="position-absolute text-white d-flex flex-column align-items-center justify-content-center"
            ...
            <div class="text-center">
                @if (auth()->check())
                    ...
                    <a href="{{ route('foto.create') }}" class="btn btn-sm px-3 py-2 text-white mt-3 mt-sm-0 mx-1"
                        style="border-radius: 30px; border:1px solid #4346eb;"><i class="fa-solid fa-plus"></i> Add Photo</a>
                @else
                    <a href="{{ route('login') }}" class="btn btn-sm px-3 py-2 text-white mt-3 mt-sm-0 mx-1"
                        style="border-radius: 30px; background-color: #4346eb;"><i class="fa-solid fa-right-to-bracket"></i>
                        Login</a>
                    <a href="{{ route('register.create') }}" class="btn btn-sm px-3 py-2 text-white mt-3 mt-sm-0 mx-1"
                            ...
                            <div class="border rounded p-3">
                                <div class="ratio ratio-16x9 mb-3">
                                    <img src="{{ Storage::url($foto->LokasiFile) }}?quality=10"
                                        class="object-fit-cover w-100 h-100 rounded" alt="{{ $foto->JudulFoto }}" loading="lazy">
                                </div>
